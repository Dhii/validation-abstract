 ...
 * @since [*next-version*]
 */
class ValidateCapableTraitTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Validation\ValidateCapableTrait';
    ...
    /**
     * Tests that `_validate()` works as expected when subject is valid.
     *
     * @since [*next-version*]
     */
